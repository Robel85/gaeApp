...
<body>
	<div class="container">
		<%-- aufbauen der navigationsleiste--%>
		<%=new TemplatesHtml().buildNavbar()%>
		<%-- aufbauen der Überschriften--%>
		<%=new TemplatesHtml().buildHead()%>
		...
		<div id="center_container">
			...
			<div id="all_pois" class="poi"
				onmouseover="init_maptilesStorePoiInfo()">
				<%
			...
			<div id="form_section">
				...
				<div id="chooseMaps" style="font-size: x-large; width: 635px;">
					<table>
						...
						<tr>
							<ul>
								<!-- Maps können über diese Links gewechselt werden -->
						...
						<tr>
							<!-- Buttons für die leichtere Navigation -->
							<a href="maps.jsp?id=<%=cont.targetMap%>&xCord=0&yCord=-1"><img
								alt="up" src="/static/img/arrow_up_4.png" width="120px"></a>

							<a href="maps.jsp?id=<%=cont.targetMap%>&xCord=-1&yCord=0"> <img
								alt="left" src="/static/img/arrow_right_4.png" width="120px">
							</a>
							<a href="maps.jsp?id=<%=cont.targetMap%>&xCord=0&yCord=0"> <img
								alt="left" src="/static/img/view_restore.png" width="120px"></a>
							<a href="maps.jsp?id=<%=cont.targetMap%>&xCord=1&yCord=0"> <img
								alt="left" src="/static/img/arrow_left_4.png" width="120px"></a>


							<a href="maps.jsp?id=<%=cont.targetMap%>&xCord=0&yCord=1"> <img
								alt="up" src="/static/img/arrow_down_4.png" width="120px"></a>
						</tr>
					</table>
				</div>
			</div>
			...
			<div id="below">
				Kartenquelle: von
				<%=cont.getParsedPath(cont.getMaps().getWestPathList()
					.get(0))%>
				bis
				<%=cont.getParsedPath(cont.getMaps().getEastPathList()
					.get(2))%><br /> Kacheln im Format "<%=cont.getFileFormat(cont.getMaps().getWestPathList()
					.get(0))%>"
			</div>
